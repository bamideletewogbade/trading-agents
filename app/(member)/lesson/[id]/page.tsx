...
/**
 * A lesson, by id. Anything not yet playable says so and points back to
 * the roadmap, rather than a bare 404.
 */
...
export default async function LessonPage({ params }: Params) {
  ...
  return <LessonPlayer key={id} id={id} />;
}
